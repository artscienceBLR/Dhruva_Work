...
unsigned int echo_cells_2 = 64; //60
unsigned int echo_cells_3 = 128; //127
...
void updateControl(){
  ...
  long bumpy_input = (cs_4_2.capacitiveSensor(30)/1.1);
...
int updateAudio(){
  return 5*((int)aSin0.next()+aSin1.next()+(aSin2.next()>>1)
    +(aSin3.next()>>2)) >>3;
}
